  ...
  return (
    <div>
      <form onSubmit={applyFilters} className="mb-4 flex flex-col gap-3 sm:flex-row">
        ...
        <button type="submit" className="inline-flex items-center justify-center gap-2 rounded-md border border-gray-300 px-3.5 py-2 text-sm font-medium hover:bg-gray-50 dark:border-slate-700 dark:hover:bg-slate-800"><Filter className="h-4 w-4" /> Apply</button>
      </form>
